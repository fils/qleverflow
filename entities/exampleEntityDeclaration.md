...
This file contains an example of how to declare an entity in the system. It demonstrates the structure and usage of entity declarations.

These entities and their definitions can be altered and changed to address
workflows to extract entities related to any domain.
